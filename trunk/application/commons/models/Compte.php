...
class Model_Compte
{
    ...
    {
        if (null === $this->_table) {
            require_once APPLICATION_PATH_COMMONS . '/models/DbTable/Compte.php';
    ...
    {
        $table = $this->getTable();
        $select = $table->select()->from(array('c'=>'compte'), array('idCompte','login', 'img', 'citationpreferee', 'dateins'))
