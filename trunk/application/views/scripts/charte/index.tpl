...
{foreach from=$chartes item=charte name=charte}
	<a href="{$ancrage}charte_{$charte.idCharte}" class="deco"><div class="titre"><div class="titre2"><img src="img/fleche.gif" class="flecheh" alt="fleche" />{$charte.nom|capitalize}</div></div></a>
