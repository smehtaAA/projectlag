...
<a href="{$urladd}"><img src="{$baseurl}/images/admin/add.png" alt="Ajouter un jeu" class="textalignm" title="Ajouter" /> Ajouter un Jeu</a>
<br /><br />
<table align="center">
  <tr>
  	<th></th>
    ...
    <th align="left" width="150">Date Sortie</th>
