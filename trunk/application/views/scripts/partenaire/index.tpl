        ...
        {foreach from=$partenaires item=partenaire name=partenaire}
            <div class="content-total-princ content-separator">
                ...
                <div class="content-total-middle">
                    ...
                    <div class="content-title-right"></div>
                    <div class="content-total-text">
                        <a href="{$partenaire.lien}"><img src="{$base_url}/images/partenaires/{$partenaire.logo}" align="right" class="img-right-separator" style="float:right;" alt="{$partenaire.titre|capitalize|utf8_encode}" title="{$partenaire.titre|capitalize|utf8_encode}" /></a>
