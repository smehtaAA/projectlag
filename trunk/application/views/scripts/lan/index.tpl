    ...
    <div class="content-total-princ">
        ...
        <div class="content-total-middle">
            ...
            <div class="content-total-text">
                ...
                {if $lan_ouverte.idLan != $l.idLan}
                <strong><img src="{$base_url}/images/icones/icon-user.png" alt="Presents" title="Presents" style="vertical-align:middle" /> &nbsp;{$chiffre[$l.idLan].present}</strong> Pr&eacute;sents
                {/if}
                <br /><br />
