...
<a href="{$urladd}"><img src="{$base_url}/images/admin/add.png" alt="Ajouter une fonction" class="textalignm" title="Ajouter" /> Ajouter une Fonction</a>
<br /><br />
<div id="tab_content">
...
{foreach from=$datas key=myId item=i name=foo}
  <tr id="ligne_{$i.ordre}">
    ...
    <td></td>
    <td align="center"><a href="{$urlupd}{$i.idFonction}"><img src="{$base_url}/images/admin/modify.png" alt="Modifier" class="textalignm" title="Modifier" /></a></td>
    <td align="center"><a href="{$urldel}{$i.idFonction}" onclick="return(confirm('Etes-vous sur de vouloir supprimer la ligne {$smarty.foreach.foo.index+1} ?'));"><img src="{$base_url}/images/admin/delete.png" alt="Supprimer" class="textalignm" title="Supprimer" /></a></td>
  </tr>
{/foreach}
</table>
</div>