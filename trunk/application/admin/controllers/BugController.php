    ...
    public function indexadminAction() {
        ...
        if ($log->_getTypeConnected('admin') || $log->_getTypeConnected('superadmin')) {
            ...
            if ($id > 0) {
                ...
                $smarty->assign('urlupd', $request->getBaseUrl() . '/admin/bug/resoudre/?id=');
                $smarty->assign('urldel', $request->getBaseUrl() . '/admin/bug/del/?id=');
                $smarty->assign('urltri', $request->getBaseUrl() . '/admin/bug/indexadmin/?');
