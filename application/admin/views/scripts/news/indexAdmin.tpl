...
<a href="{$urladd}"><img src="{$baseurl}/images/admin/add.png" alt="Ajouter une news" class="textalignm" title="Ajouter" /> Ajouter une {$title|strtolower|utf8_encode}</a>
<br /><br />
<table align="center">
  <tr>
  	<th></th>
